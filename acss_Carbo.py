...
os.chdir(r"C:\Users\LIU Qiong\Desktop\PhD\research\present\article no.1\code\Carbo")
...
def plot_all_patients(full_data):
    ...
    plt.title('All Patients Dose-Response Curves for Carbo', fontsize=14)
...
plt.title('Counts of Each Model Being Selected as the Best Model Carbo', fontsize=14, pad=20)
...
# Chart decoration
plt.title('Carbo Dose-Response Curves (Sigmoid Emax Model)', fontsize=14, pad=20)
plt.xlabel('Dose (μM)', fontsize=12)
plt.ylabel('Response', fontsize=12)
plt.xlim(0, 250)
plt.ylim(-0.05, 1.2)
...
plt.suptitle('Carbo CRS-ASI Classification Analysis', fontsize=14, y=1.02)
...
if not loocv_results_df.empty:
    ...
    plt.suptitle('Carbo CRS-ASI LOOCV Analysis', fontsize=16, y=1.02)
...
def plot_msscf_grouped_fitted_curves(sigmoid_results, all_patients_df, dose_range=(0, 50), num_points=200):
    ...
    # Chart decorations
    plt.title('Carbo Fitted Sigmoid Emax Curves by Grouping (0-50 μM)', fontsize=14, pad=20)
    plt.xlabel('Dose (μM)', fontsize=12)
    plt.ylabel('Response', fontsize=12)
...
plt.figure(figsize=(20, 6))
plt.suptitle('Carbo IC50-CI Classification Analysis', fontsize=14, y=1.02)
...
# 1. CRS distribution
plt.figure(figsize=(20,6))
plt.suptitle('Carbo CRS-CI Classification Analysis', fontsize=14, y=1.02)
...
if not loocv_results_df.empty:
    plt.figure(figsize=(20, 12))
    plt.suptitle('Carbo CRS-CI LOOCV Analysis', fontsize=16, y=1.02)
...
plt.figure(figsize=(20, 12))
plt.suptitle('Carbo Comparison of Clustering Methods Across Metrics', fontsize=16, y=1.02)
...
plt.tight_layout(pad=2.0)
plt.savefig(f"Carbo_Comparison_Barplot.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Method')
plt.tight_layout()
plt.savefig(f"Carbo_Comparison_Heatmap.png", dpi=300, bbox_inches='tight')
plt.show()
...
plot_radar(
    ...
    'Carbo Radar Plot of Composite Metrics Across Methods',
     f"Carbo_Composite_Metrics_Radarplot.png"
)
