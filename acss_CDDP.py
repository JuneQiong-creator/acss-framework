...
plt.tight_layout()
plt.savefig("CDDP_best_model_distribution.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('CDDP_all_patients_best_model_curves.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(f"CDDP_CRS_ASI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()
...
if not loocv_results_df.empty:
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/CDDP_CRS_ASI_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_msscf_grouped_fitted_curves(sigmoid_results, all_patients_df, dose_range=(0, 50), num_points=200):
    ...
    # Save plot
    output_path = "CDDP_grouped_fitted_curves.png"
    plt.tight_layout()
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.show()
...
plt.tight_layout(pad=2.0)
plt.savefig(f"CDDP_IC50_CI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()
...
if not loocv_results_df.empty:
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/CDDP_IC50_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
plt.tight_layout(pad=2.0)
plt.savefig(f"CDDP_CRS_CI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()
...
if not loocv_results_df.empty:
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/CDDP_CRS_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
for (algo_name, model), out_dir in zip(algorithms, output_dirs):
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"CDDP_{algo_name}_Clustering_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    if not loocv_df.empty:
        ...
        plt.tight_layout(pad=2.0)
        plt.savefig(f"{out_dir}/CDDP_{algo_name}_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
        plt.show()
...
plt.tight_layout(pad=2.0)
plt.savefig(f"CDDP_Comparison_Barplot.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(alpha=0.2)
plt.tight_layout()
plt.savefig(f"CDDP_IPES_Ranking_Barplot.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Method')
plt.tight_layout()
plt.savefig(f"CDDP_Comparison_Heatmap.png", dpi=300, bbox_inches='tight')
plt.show()
...
plot_radar(
    ...
    'CDDP Radar Plot of Composite Metrics Across Methods',
     f"CDDP_Composite_Metrics_Radarplot.png"
)
