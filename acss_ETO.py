...
os.chdir(r"C:\Users\LIU Qiong\Desktop\PhD\research\present\article no.1\code\ETO")
...
df_group5 = pd.DataFrame({
    ...
    '2': [-0.0986, 0.0927, 0.0219, 0.1372, -0.0058],
    '4': [0.1489, -0.0948, -0.0340, 0.1343, -0.0064],
    '10': [0.4089, 0.1089, -0.1445, 0.0784, 0.0070],
    '20': [0.3594, 0.3144, 0.3638, 0.0909, 0.0482],
    '50': [0.3402, 0.2604, 0.3306, 0.0512, 0.2861],
    '100': [0.2835, 0.3561, 0.5971, -0.0083, 0.1521],
    '500': [0.4339, 0.2309, 0.7567, 0.0821, 0.2892]
})
...
def plot_all_patients(full_data):
    ...
    plt.title('All Patients Dose-Response Curves for ETO', fontsize=14)
    ...
    plt.tight_layout()
    plt.savefig("ETO_all_patients_comparison.png", dpi=300, bbox_inches='tight')
    plt.show()
...
plt.title('Counts of Each Model Being Selected as the Best Model ETO', fontsize=14, pad=20)
...
plt.tight_layout()
plt.savefig("ETO_best_model_distribution.png", dpi=300)
plt.show()
...
# Chart decoration
plt.title('ETO Dose-Response Curves (Sigmoid Emax Model)', fontsize=14, pad=20)
plt.xlabel('Dose (μM)', fontsize=12)
plt.ylabel('Response', fontsize=12)
plt.xlim(0, 250)
plt.ylim(-0.05, 1.2)
...
plt.tight_layout()
plt.savefig('ETO_all_patients_best_model_curves.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.suptitle('ETO CRS-ASI Classification Analysis', fontsize=14, y=1.02)
...
plt.savefig(f"ETO_CRS_ASI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()

# --- LOOCV visualization ---
if not loocv_results_df.empty:
    plt.figure(figsize=(20,12))
    plt.suptitle('ETO CRS-ASI LOOCV Analysis', fontsize=16, y=1.02)
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/ETO_CRS_ASI_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
def plot_msscf_grouped_fitted_curves(sigmoid_results, all_patients_df, dose_range=(0, 50), num_points=200):
    ...
    # Chart decorations
    plt.title('ETO Fitted Sigmoid Emax Curves by Grouping (0-50 μM)', fontsize=14, pad=20)
    plt.xlabel('Dose (μM)', fontsize=12)
    plt.ylabel('Response', fontsize=12)
    ...
    # Save plot
    output_path = "ETO_grouped_fitted_curves.png"
    plt.tight_layout()
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.show()
...
plt.figure(figsize=(20, 6))
plt.suptitle('ETO IC50-CI Classification Analysis', fontsize=14, y=1.02)
...
plt.tight_layout(pad=2.0)
plt.savefig(f"ETO_IC50_CI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()

# --- LOOCV Visualization ---
if not loocv_results_df.empty:
    plt.figure(figsize=(20, 12))
    plt.suptitle('ETO IC50-CI LOOCV Analysis', fontsize=16, y=1.02)
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/ETO_IC50_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
# 1. CRS distribution
plt.figure(figsize=(20,6))
plt.suptitle('ETO CRS-CI Classification Analysis', fontsize=14, y=1.02)
...
plt.tight_layout(pad=2.0)
plt.savefig(f"ETO_CRS_CI_Classification_Visualization.png", dpi=300, bbox_inches='tight')
plt.show()

# --- LOOCV Visualization ---
if not loocv_results_df.empty:
    plt.figure(figsize=(20, 12))
    plt.suptitle('ETO CRS-CI LOOCV Analysis', fontsize=16, y=1.02)
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"{output_dir}/ETO_CRS_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
...
for (algo_name, model), out_dir in zip(algorithms, output_dirs):
    ...
    plt.tight_layout(pad=2.0)
    plt.savefig(f"ETO_{algo_name}_Clustering_Visualization.png", dpi=300, bbox_inches='tight')
    plt.show()
    ...
    if not loocv_df.empty:
        ...
        plt.tight_layout(pad=2.0)
        plt.savefig(f"{out_dir}/ETO_{algo_name}_LOOCV_Analysis_Visualization.png", dpi=300, bbox_inches='tight')
        plt.show()
...
plt.figure(figsize=(20, 12))
plt.suptitle('ETO Comparison of Clustering Methods Across Metrics', fontsize=16, y=1.02)
...
plt.tight_layout(pad=2.0)
plt.savefig(f"ETO_Comparison_Barplot.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(alpha=0.2)
plt.tight_layout()
plt.savefig(f"ETO_IPES_Ranking_Barplot.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('Method')
plt.tight_layout()
plt.savefig(f"ETO_Comparison_Heatmap.png", dpi=300, bbox_inches='tight')
plt.show()
...
plot_radar(
    ...
    'ETO Radar Plot of Composite Metrics Across Methods',
     f"ETO_Composite_Metrics_Radarplot.png"
)
